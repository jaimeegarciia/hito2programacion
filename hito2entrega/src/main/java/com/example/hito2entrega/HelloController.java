...
public class HelloController {
    ...
    protected void onSaveButtonClick() {
        ...
        if (team != null) {
            ...
            saveTeamToDatabase(team); // Save team to MongoDB
            tableView.refresh();
            clearFields();
    ...
    protected void onModifyButtonClick() {
        ...
        if (selectedTeam != null) {
            try {
                // Actualiza los campos del equipo seleccionado con los nuevos valores
                ...
                selectedTeam.setPoints(wins * 3 + draws); // Calcula los puntos
    ...
    private void saveTeamToDatabase(Team team) {
        // Convertir el objeto Team a un Document de MongoDB
        ...
        // Insertar el Document en la colección teams
        collection.insertOne(doc);
    }

    private void updateTeamInDatabase(Team team) {
        // Actualizar el equipo en MongoDB
    ...
    private void deleteTeamFromDatabase(Team team) {
        // Eliminar el equipo de MongoDB
        collection.deleteOne(eq("name", team.getName()));
    }

    @FXML
    public void initialize() {
        // Cargar equipos desde la base de datos MongoDB al iniciar la aplicación
